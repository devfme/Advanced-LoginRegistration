...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="#">Advanced LR</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="sessions/logout.php">Logout</a>
            </li>
        </ul>
    </div>
</nav>
...
<div class="container" style="margin-top:30px">
    <div class="row">
        <div class="col-sm-4">
            <h5>About Me (<?php echo $_SESSION['lr_name']?>)</h5>
                 <div class="fakeimg">image thumbnail</div>
